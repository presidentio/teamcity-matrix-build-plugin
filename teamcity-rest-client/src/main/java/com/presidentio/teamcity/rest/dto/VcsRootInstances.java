...
/**
 * <p>Java class for vcsRootInstances complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="vcsRootInstances"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://dto.rest.teamcity.presidentio.com}vcsRootInstance" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class VcsRootInstances {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vcsRootInstance property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVcsRootInstance().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<VcsRootInstance> getVcsRootInstance() {
        if (vcsRootInstance == null) {
            vcsRootInstance = new ArrayList<VcsRootInstance>();
        }
        return this.vcsRootInstance;
    }
