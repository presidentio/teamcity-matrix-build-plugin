 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://dto.rest.teamcity.presidentio.com}plugin" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class PluginInfos {
    ...
    protected List<PluginInfo> plugin;
     ...
     * 
     */
    public List<PluginInfo> getPlugin() {
        if (plugin == null) {
            plugin = new ArrayList<PluginInfo>();
        }
        return this.plugin;
    }
