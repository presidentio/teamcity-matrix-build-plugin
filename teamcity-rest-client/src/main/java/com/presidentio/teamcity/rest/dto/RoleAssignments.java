 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://dto.rest.teamcity.presidentio.com}role" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RoleAssignments {
    ...
    protected List<RoleAssignment> role;
     ...
     * 
     */
    public List<RoleAssignment> getRole() {
        if (role == null) {
            role = new ArrayList<RoleAssignment>();
        }
        return this.role;
    }
